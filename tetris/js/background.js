...
(function () {
  ...
  function buildCity() {
    const list = [];
    const back = [
      [.00,.55,.07],[.06,.48,.05],[.10,.53,.08],[.17,.45,.06],
      [.22,.51,.09],[.30,.43,.05],[.34,.49,.07],[.40,.47,.06],
      [.45,.55,.08],[.52,.43,.05],[.56,.49,.07],[.62,.53,.09],
      [.70,.45,.05],[.74,.51,.08],[.81,.47,.06],[.86,.55,.07],
      [.92,.46,.08],
    ];
    back.forEach(([x,y,w]) => list.push({ x, y, w, h:1-y, layer:0 }));

    const front = [
      [.00,.65,.09],[.08,.61,.07],[.14,.63,.10],[.23,.59,.08],
      [.30,.62,.11],[.40,.60,.09],[.48,.65,.07],[.54,.57,.12],
      [.65,.61,.08],[.72,.65,.10],[.81,.60,.09],[.89,.63,.11],
    ];
